...
if (canvas && !matchMedia('(max-width:760px), (pointer:coarse) and (max-width:1024px)').matches) {
  ...
  try {
    ...
    const evidenceLight=new T.SpotLight(0xffa85f,26,5.8,.58,.76,1.65);evidenceLight.position.set(-5.1,4.05,1.65);evidenceLight.target.position.set(-4.9,1.1,.62);evidenceLight.castShadow=true;evidenceLight.shadow.mapSize.set(512,512);scene.add(evidenceLight,evidenceLight.target);
